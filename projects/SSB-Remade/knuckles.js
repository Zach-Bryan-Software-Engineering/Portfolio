class Knuckles {
    constructor(x, y, leftKey, rightKey, jumpKey, playerNumber, move1key, move2key, move3key) {
        ...
        this.animations = {
            resting: { 
                src: 'https://codehs.com/uploads/23dcd71968e05bd95f869bfa6c48320d', 
                frameCount: 4, 
                frameWidth: 82, 
                frameHeight: 110, 
                frameSpeed: 10,
            ...
            running: { 
                src: 'https://codehs.com/uploads/721dd14e491346199655b7bbc7a44284', 
                frameCount: 8, 
                frameWidth: 110,
                frameHeight: 110, 
                frameSpeed: 10,
            ...
            jumping: { 
                src: 'https://codehs.com/uploads/e9856cf2406befb1228c4e83683a8f5b', 
                frameCount: 8, 
                frameWidth: 96, 
                frameHeight: 110, 
                frameSpeed: 12,
            ...
            moving1: { 
                src: 'https://codehs.com/uploads/20733d81309f79e7edea12b9ff07f1d9', 
                frameCount: 3, 
                frameWidth: 110, 
                frameHeight: 220, 
                frameSpeed: 10,
            ...
            moving2: { 
                src: 'https://codehs.com/uploads/4e0d9060c0240ed8e4965babb8d73b4d', 
                frameCount: 4, 
                frameWidth: 110, 
                frameHeight: 110, 
                frameSpeed: 5,
            ...
            moving3Part1: { 
                src: 'https://codehs.com/uploads/2fc7f1674813f80afbbbb317e75fd057', 
                frameCount: 5, 
                frameWidth: 120, 
                frameHeight: 110, 
                frameSpeed: 3,
    ...
    update(keys, deltaTime) {
        ...
        if (keys[this.controls.move1] && !this.stateLock && this.currentlyInMove === false) {
            if (this.move1CoolDown === 0) {
                ...
                setTimeout(() => {
                    ...
                    upperCutPunch(this.playerNumber, direction);
        ...
        if (keys[this.controls.move2] && !this.stateLock && this.currentlyInMove === false) {
            if (this.move2CoolDown === 0) {
                ...
                playSound('https://codehs.com/uploads/465f982499d34ab9182faf948e3c4988', 6, .4, false);
                // Fire the projectile

                
                const interval = setInterval(() => {
                    const direction = this.facingLeft ? -1 : 1;
                    superDash(this.playerNumber, direction);
                    if (this.facingLeft === true) {
                        knockback(-150, 0 ,this.playerNumber);
                    }
                    else {
                        knockback(150, 0 , this.playerNumber);
                    } 
        ...
        if (keys[this.controls.move3] && !this.stateLock && this.currentlyInMove === false) {
            if (this.move3CoolDown === 0) {
                ...
                setTimeout(() => {
                    this.stateLock = false; // Unlock state changes
                    const direction = this.facingLeft ? -1 : 1;
                    superPunch(this.playerNumber, direction);
                }, 250); // 2000ms = 2 seconds
        ...
        if (keys['o'] && !this.stateLock && this.currentlyInMove === false) {
            if (this.move3CoolDown === 0) {
                this.currentlyInMove = true;
                this.state = 'moving3Part1';
                this.stateLock = true; // Lock state changes
                ...
                setTimeout(() => {
                    this.stateLock = false; // Unlock state changes
                    const direction = this.facingLeft ? -1 : 1;
                    adminCheatMove(this.playerNumber, direction);
                }, 250); // 2000ms = 2 seconds
